...
export function initSocketViewer(containerId) {
    ...
    requestAnimationFrame(() => {
        ...
        console.log('SocketViewer: loading model models/Socket_Wrench.glb');
        loader.load(
            'models/Socket_Wrench.glb',
            (gltf) => {
                console.log('SocketViewer: model loaded');
                ...
                console.log('SocketViewer: pivot bounds', { size: size2, center: center2 });
            ...
            undefined,
            (err) => console.error('Failed to load Socket_Wrench model:', err)
        );
